// Ported from vercel/ai-elements @ main (packages/elements/src/message.tsx).
...
import {
  ButtonGroup,
  ButtonGroupText,
} from "@/components/registry/primitives/core/button-group";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "is-user:dark wrap-break-word flex w-fit min-w-0 max-w-full flex-col gap-2 overflow-hidden text-sm",
