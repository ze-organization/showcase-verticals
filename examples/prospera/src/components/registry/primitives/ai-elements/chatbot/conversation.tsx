// Ported from vercel/ai-elements @ main (packages/elements/src/conversation.tsx).
...
export const ConversationScrollButton = ({
  ...
  return (
    !isAtBottom && (
      <Button
        className={cn(
          "absolute start-[50%] bottom-4 translate-x-[-50%] rounded-full dark:bg-background dark:hover:bg-muted",
          className,
        )}
