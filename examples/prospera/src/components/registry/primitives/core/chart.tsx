...
// IMPORTANT: this module statically imports the full ~200KB recharts
// bundle. New consumers MUST be loaded behind a `next/dynamic`
// boundary (see _renderer-manifest.ts → ChartPreview) so the bundle is
// only paid for on chart-rendering routes.
