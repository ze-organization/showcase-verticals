    ...
    >
      <div className="flex max-w-sm flex-col items-center gap-6 text-center">
        ...
        <div className="flex flex-col items-center gap-1.5">
          <h1 className="font-semibold text-2xl">{finalTitle}</h1>
          {finalErrorCode && (
            <p className="text-muted-foreground text-sm">{finalErrorCode}</p>
          )}
        </div>
...
export { ErrorStates, type ErrorStatesProps, errorStatesVariants };
