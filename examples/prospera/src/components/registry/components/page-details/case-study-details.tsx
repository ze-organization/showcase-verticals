...
interface CaseStudyDetailsProps extends Omit<ComponentProps, "params"> {
...
function resolveFields(
  ...
  return {
    ...
    Client: pickText(renderingFields?.Client, route.Client),
    Category: pickText(renderingFields?.Category, route.Category),
    Problem: pickText(renderingFields?.Problem, route.Problem),
    Solution: pickText(renderingFields?.Solution, route.Solution),
      ...
      >
        <div className="grid grid-cols-12 @[768px]:gap-4 gap-y-6">
            ...
            >
              ...
              <section className="@[768px]:mt-10 mt-6">
                <h2 className="mb-3 text-xl">Problem</h2>
                <RichText
                  data-slot="rich-text"
                  className={detailsProseClass(params)}
              ...
              <section className="@[768px]:mt-10 mt-6">
                <h2 className="mb-3 text-xl">Solution</h2>
                <RichText
                  data-slot="rich-text"
                  className={detailsProseClass(params)}
                  value={resolved.Solution}
                  isEditing={isPageEditing}
...
export const Default = sitecorePassthrough(CaseStudyDetails);
