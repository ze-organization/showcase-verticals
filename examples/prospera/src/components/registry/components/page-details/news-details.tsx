...
interface NewsDetailsProps extends Omit<ComponentProps, "params"> {
...
function resolveFields(
  ...
  return {
    ...
    Source: pickText(renderingFields?.Source, route.Source),
    DisplayDate: pickText(renderingFields?.DisplayDate, route.DisplayDate),
  };
}
            ...
            {(resolved.Source?.value ||
              ...
              <p className="mt-4 text-muted-foreground text-sm">
                <Text
                  ...
                  placeholder="Source"
                />
                {resolved.Source?.value && resolved.DisplayDate?.value
                  ? " · "
                  : null}
                <Text
                  tag="span"
                  value={resolved.DisplayDate}
                  isEditing={isPageEditing}
                  placeholder="Date"
                />
              </p>
...
export const Default = sitecorePassthrough(NewsDetails);
