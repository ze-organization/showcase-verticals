...
interface Fields {
  ...
  Venue: Field<string>;
  VirtualUrl: Field<string>;
  RegistrationAction: LinkField;
}

interface EventDetailsProps extends Omit<ComponentProps, "params"> {
...
function resolveFields(
  ...
  return {
    ...
    Venue: pickText(renderingFields?.Venue, route.Venue),
    VirtualUrl: pickText(renderingFields?.VirtualUrl, route.VirtualUrl),
    RegistrationAction: pickLink(
      renderingFields?.RegistrationAction,
        ...
        <div className="grid grid-cols-12 @[768px]:gap-4 gap-y-6">
            ...
            >
              ...
              <dl className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <Fact
                  label="Virtual"
                  value={resolved.VirtualUrl}
                  isPageEditing={isPageEditing}
                  placeholder="Virtual URL"
                />
              </dl>
              {(isPageEditing || hasHref(resolved.RegistrationAction)) && (
                <div className="mt-8">
                  <Button link={resolved.RegistrationAction} showArrow />
                </div>
              )}
              <RichText
                data-slot="rich-text"
            ...
            <div className="order-3 @[768px]:col-span-3 col-span-12 @[768px]:col-start-10">
              {rendering ? (
...
export const Default = sitecorePassthrough(EventDetails);
