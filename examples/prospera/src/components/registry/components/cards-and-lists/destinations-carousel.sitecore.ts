/**
 * Per-component Sitecore adapter for `destinations-carousel` — wires the shared
 * destinations-family `adaptCarouselProps` (Sitecore {fields, params} → flat { items, … })
 ...
 * export names.
 */
import { adaptCarouselProps } from "./destinations.sitecore";
