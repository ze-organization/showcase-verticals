/**
 * Per-component Sitecore adapter for `products-carousel` — wires the shared
 * products-family `adaptCarouselProps` (Sitecore {fields, params} → flat { items, … })
 ...
 * export names.
 */
import { adaptCarouselProps } from "./products.sitecore";
