/**
 * Per-component Sitecore adapter for `person-carousel` — wires the shared
 * person-family `adaptCarouselProps` (Sitecore {fields, params} → flat { items, … })
 ...
 * export names.
 */
import { adaptCarouselProps } from "./persons.sitecore";
