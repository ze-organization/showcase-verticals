/**
 * Per-component Sitecore adapter for `locations-carousel` — wires the shared
 * locations-family `adaptCarouselProps` (Sitecore {fields, params} → flat { items, … })
 ...
 * export names.
 */
import { adaptCarouselProps } from "./locations.sitecore";

export const Default = adaptCarouselProps;
export const MapAbove = adaptCarouselProps;
