/**
 * Per-component Sitecore adapter for `offers-carousel` — wires the shared
 * offers-family `adaptCarouselProps` (Sitecore {fields, params} → flat { items, … })
 ...
 * export names.
 */
import { adaptCarouselProps } from "./offers.sitecore";
