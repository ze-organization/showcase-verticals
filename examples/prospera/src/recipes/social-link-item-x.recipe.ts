 ...
 */
export const socialLinkItemXRecipe = {
  kind: "content-item",
  schemaVersion: "1",
  handle: "social-link-item-x@1",
  name: "social-link-item-x",
  displayName: "X",
  description:
    "Stock SocialLinks item: X profile link. Repoint the URL at the brand's own profile.",
  templateType: "social-link-item@1",
  fields: {
    Platform: { shape: "enum", value: "x" },
    Link: {
      shape: "link-external",
...
export default socialLinkItemXRecipe;
