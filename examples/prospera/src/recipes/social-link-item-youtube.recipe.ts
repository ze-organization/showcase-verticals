 ...
 */
export const socialLinkItemYoutubeRecipe = {
  kind: "content-item",
  schemaVersion: "1",
  handle: "social-link-item-youtube@1",
  name: "social-link-item-youtube",
  displayName: "YouTube",
  description:
    "Stock SocialLinks item: YouTube profile link. Repoint the URL at the brand's own profile.",
  templateType: "social-link-item@1",
  fields: {
    Platform: { shape: "enum", value: "youtube" },
    Link: {
      shape: "link-external",
...
export default socialLinkItemYoutubeRecipe;
