 ...
 * different section.
 */
export const uiSectionRecipe = {
  kind: "component-section",
  schemaVersion: "1",
  handle: "ui-section@1",
  icon: sectionIcons["ui-section@1"],
  name: "ui",
  displayName: "UI",
  description:
    "Foundational UI building blocks — buttons, badges, cards, rich text, accordions.",
} satisfies ComponentSectionRecipe;

export default uiSectionRecipe;
