 ...
 */
export const socialLinkItemTiktokRecipe = {
  kind: "content-item",
  schemaVersion: "1",
  handle: "social-link-item-tiktok@1",
  name: "social-link-item-tiktok",
  displayName: "TikTok",
  description:
    "Stock SocialLinks item: TikTok profile link. Repoint the URL at the brand's own profile.",
  templateType: "social-link-item@1",
  fields: {
    Platform: { shape: "enum", value: "tiktok" },
    Link: {
      shape: "link-external",
      href: "https://tiktok.com/@acme",
      text: "TikTok",
    },
  },
} satisfies ContentItemRecipe;

export default socialLinkItemTiktokRecipe;
